...
int main(int argc, char **argv) {
    ...
    */
    ...
    cudaMemcpy(testdev->merkel_root_,merkl.c_str(), BLAKE2B_OUTBYTES, cudaMemcpyHostToDevice);
    ...
    index += mhash.length();
    cudaMemcpy(testdev->work_template_+index,testdev->merkel_root_,BLAKE2B_OUTBYTES,cudaMemcpyDeviceToDevice);
 ...
 m,/
    ...
    */
    ...
    setup_rand<<<blocks,threads>>>(devStates,((uint32_t*)work_char)[0]);
